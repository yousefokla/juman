...
import { Star, ShieldCheck, UserCheck, MessageCircle, Phone, Award } from "lucide-react";
          ...
          {REVIEWS.map((review) => (
            ...
            >
              ...
              <div className="mt-6 pt-4 border-t border-slate-100 flex items-center justify-between">
                <div>
                  <h4 className="font-bold text-[#0f1c24] text-sm">
                    {review.name}
                  </h4>
        ...
        <div className="bg-[#0f1c24] text-white rounded-3xl p-8 sm:p-12 text-center space-y-6 max-w-4xl mx-auto shadow-xl">
          ...
          <div className="flex flex-wrap justify-center gap-4 pt-2">
            <a
              ...
              className="flex items-center gap-2 bg-[#25D366] text-white px-7 py-3 rounded-xl font-bold text-sm shadow-md"
            >
            ...
            <a
              ...
              className="flex items-center gap-2 bg-[#256F96] text-white px-6 py-3 rounded-xl font-bold text-sm"
            >
